...
export default function Calculator({ plans }) {
  ...
  return (
    <section className="mt-8 py-10 bg-person-tertiary" id="planos">
      <div className="flex flex-col gap-4 md:gap-8 items-center">
        ...
        <div className="flex flex-col md:flex-row w-full md:px-20 max-w-[1080px]">
          <div className="md:border-r-[1px] md:border-person-primary text-person-secondary flex-1 md:rounded-l-lg p-4">
                ...
                <ul className="flex w-full">
                  {
                    plans.plansOptions.map(option => (
                      <li
                        ...
                        className={`cursor-pointer flex justify-center items-center px-2 py-4 md:px-4 w-full last:rounded-r-lg first:rounded-l-lg border cursor pointer font-ton ${option.value === plan ? 'border-ton-200 text-ton-200 font-bold' : 'border-ton-100 text-ton-100'}`}
                      >
                        {option.text}
                      </li>
                    ))
              ...
              <div className="flex flex-col w-full gap-y-4">
                ...
                <div>
                  ...
                  <NumericFormat
                    ...
                    alt="Valor em reais"
                    className="bg-person-primary md:px-4 w-full border inline-flex w-full rounded border px-4 py-2 text-white font-semibold text-sm shadow-sm focus:outline-none focus:border-ton-300"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="text-person-secondary flex-1 flex flex-col md:rounded-r-lg p-4 justify-center">
            ...
            <div className="flex justify-between items-center m-4 bg-ton-gray2 rounded-lg p-4 gap-4">
